...
- **🎯 Dynamic Question Generation**: Each candidate receives unique, personalized interview questions generated by Gemini AI based on their resume and the job description (NO static question bank)
- **AI-Powered Interviews**: Uses Gemini AI to create job-specific and candidate-specific questions
...
- **Full Metadata Tracking**: Every question includes generation metadata proving it's JD + resume specific
...
### Dynamic Question Generation (NEW!)

**Every candidate receives UNIQUE questions** - no static question bank is used.

1. **Personalized Oral Questions**: Generated based on:
   - Specific projects mentioned in the candidate's resume
   - Job description requirements
   - Candidate's experience level
   - Required skills for the role

2. **Personalized Coding Questions**: Generated based on:
   - Programming languages in the candidate's resume
   - Role-specific challenges from the JD
   - Candidate's technical background
   - Experience level

3. **Full Transparency**: Every question includes metadata showing:
   - When it was generated
   - What it's testing (focus area)
   - Difficulty level
   - Proof it's based on that candidate's resume + JD

**📖 For complete details, see [DYNAMIC_QUESTION_GENERATION.md](./DYNAMIC_QUESTION_GENERATION.md)**
...
### Gemini API (Recommended for Dynamic Questions)

To enable **fully AI-powered dynamic question generation**:
1. Get an API key from [Google AI Studio](https://makersuite.google.com/app/apikey)
2. Add to `.env`: `GEMINI_API_KEY=your-key-here`

**With API Key:**
- Each candidate gets unique, AI-generated questions based on their resume
- Questions reference specific projects and skills from their background
- Highly personalized and role-specific

**Without API Key:**
- System uses intelligent fallback generation
- Questions are still personalized based on detected skills from resume
- Not as sophisticated as AI-powered generation, but still functional
